...
export default function BotaoReciboAvulso() {
  ...
  const corPrimaria = '#16a34a'
  const corSecundaria = config.corSecundaria || '#f5f1e8'
  const corCard = '#ffffff'
  const corTextoSuave = '#64748b'
  const fundoPainel = '#f8fafc'
  const fundoCampo = '#ffffff'
  const bordaCampo = '#dbe3f0'
  const textoClaro = '#0f172a'
  const textoSuaveEscuro = '#475569'
        ...
        >
          ...
          >
            <div
              style={{
                padding: '20px 22px',
                background: `linear-gradient(135deg, ${corPrimaria}, #22c55e)`,
                color: '#fff',
              }}
            >
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <br />
                        <div style={{ fontSize: 11, fontWeight: 900, color: '#334155', marginBottom: 4 }}>
                          VALOR
                        </div>
                        <div
                          style={{
                    ...
                    >
                      <div style={{ fontWeight: 900, marginBottom: 5, color: '#334155' }}>
