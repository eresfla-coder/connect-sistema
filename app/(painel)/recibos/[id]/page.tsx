...
export default function ReciboDetalhePage() {
  ...
  if (carregado && !recibo) {
    return (
      <div className="min-h-screen bg-[linear-gradient(180deg,#081120_0%,#0d1b33_100%)] px-4 py-6">
        <div className="mx-auto max-w-3xl rounded-[28px] border border-slate-200/80 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.10)]">
  ...
  return (
    <>
      ...
      <div className="print-root min-h-screen bg-[linear-gradient(180deg,#081120_0%,#0d1b33_100%)] px-4 py-6">
        ...
        <div className="print-card mx-auto w-full max-w-[820px] rounded-[28px] border border-neutral-200 bg-white p-8 shadow-[0_10px_35px_rgba(0,0,0,0.06)]">
          ...
          <section className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-4 shadow-[0_8px_24px_rgba(15,23,42,0.05)]">
